...
export function SliderVideo(){
    return (
        <div className="relative -[80vw] w-full md:g[56.25vw] lg:h-[45vw]">
            <video 
                autoPlay 
                loop 
                muted 
                className="brightness-50 object-fill w-full h-[80vw] md:g[56.25vw] lg:h-[45vw]" 
            ...
            <div className="flex flex-col justify-end absolute w-full md:w-[36%] px-4 md:px-0 md:left-[4%] z-20 top-0 -bottom-7 md:bottom-[36%]">
                <div className="pt-24 md:pt-0">
                    ...
                    <p className="max-w-md mt-2 text-xs md:text-base">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempora, blanditiis aperiam recusandae explicabo voluptatibus provident vero facilis quo sunt commodi laudantium quis! Omnis aspernatur cum fugiat dignissimos impedit blanditiis excepturi.
                    </p>
